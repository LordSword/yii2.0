...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li class="click"><span><img src="<?= $this->baseUrl?>/admin/images/t01.png" /></span>添加</li>
            <li class="click"><span><img src="<?= $this->baseUrl?>/admin/images/t02.png" /></span>修改</li>
            <li><span><img src="<?= $this->baseUrl?>/admin/images/t03.png" /></span>删除</li>
            <li><span><img src="<?= $this->baseUrl?>/admin/images/t04.png" /></span>统计</li>
        </ul>


        <ul class="toolbar1">
            <li><span><img src="<?= $this->baseUrl?>/admin/images/t05.png" /></span>设置</li>
        </ul>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <th>编号<i class="sort"><img src="<?= $this->baseUrl?>/admin/images/px.gif" /></i></th>
            <th>标题</th>
            <th>用户</th>
            <th>籍贯</th>
            <th>发布时间</th>
